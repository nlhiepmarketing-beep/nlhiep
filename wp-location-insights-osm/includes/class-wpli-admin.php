...
if ( ! class_exists( 'WPLI_Admin' ) ) {
	class WPLI_Admin {
		...
		public function remove_duplicate_submenu() {
			remove_submenu_page( 'wpli_main', 'wpli_main' );
		}

		public function register_settings() {
			register_setting( 'wpli_settings_group', WPLI_OPTION_KEY, array( $this, 'sanitize_settings' ) );
			...
			$fields = array(
				...
				'always_enqueue'            => __( 'Luôn tải asset ở frontend', 'wp-location-insights-osm' ),
		...
		public function sanitize_settings( $input ) {
			...
			$output['always_enqueue']       = isset( $input['always_enqueue'] ) ? 1 : 0;
		...
		public function render_settings_page() {
			...
			<div class="wrap">
				...
				<form method="post" action="options.php">
					...
					<?php do_settings_sections( 'wpli_settings' ); ?>
					<?php submit_button(); ?>
				</form>
				<hr />
