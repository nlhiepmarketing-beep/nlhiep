...
if ( ! class_exists( 'WPLI_CPT' ) ) {
	class WPLI_CPT {
		public function __construct() {
			add_action( 'init', array( $this, 'register_cpt' ) );
			add_action( 'add_meta_boxes', array( $this, 'register_meta_boxes' ) );
			add_action( 'save_post_wpli_location', array( $this, 'save_meta' ), 10, 2 );
			add_filter( 'manage_wpli_location_posts_columns', array( $this, 'columns' ) );
			add_action( 'manage_wpli_location_posts_custom_column', array( $this, 'column_content' ), 10, 2 );
		...
		public function render_coords_box( $post ) {
